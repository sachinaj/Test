                        ...
                        <div class="card-body">
                            <form action="" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="state" id="formGroupExampleInput2" placeholder="State">
                                </div>
                                <div class="mb-3">
                                    <label for="formGroupExampleInput2" class="form-label">District</label>
                                    <input type="text" class="form-control" name="district" id="formGroupExampleInput2" placeholder="District">
                                </div>
                                <div class="mb-3">
